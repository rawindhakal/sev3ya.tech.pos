...
const ICON_PATHS: Record<string, React.ReactNode> = {
  ...
  HRM: (<><rect width="20" height="14" x="2" y="7" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></>),
...
const NAV: NavNode[] = [
  ...
  {
    label: 'Marketing', icon: '🎟️', feature: 'marketing',
    children: [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/sales-forecast', label: 'AI Sales Analysis' },
  ...
  {
    label: 'HRM', icon: '🗂️', feature: 'hrm',
    children: [
      { href: '/hr', label: 'Overview' },
      { href: '/attendance', label: 'Attendance & Payroll' },
      { href: '/hr/leave', label: 'Leave & Time-off' },
      { href: '/hr/shifts', label: 'Shift Scheduling' },
      { href: '/hr/documents', label: 'Employee Documents' },
      { href: '/hr/performance', label: 'Performance & Discipline' },
    ],
  },
